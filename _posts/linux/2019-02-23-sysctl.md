---
layout: post
title:  "리눅스 커널 튜닝 파라마터 sysctl.conf"
date:   2019-02-23 09:01:00 +0900
categories: linux
tags: linux
---

# 리눅스 커널 튜닝 파라마터 sysctl.conf

<https://klaver.it/linux/sysctl.conf> 를 `/etc/sysctl.conf`에 적용한다.  
인터넷에 연결되어 있으면 `curl -O https://klaver.it/linux/sysctl.conf `로 다운로드 하면 된다.  
